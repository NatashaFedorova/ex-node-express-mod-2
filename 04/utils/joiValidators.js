...
exports.createUserValidator = (data) => Joi.object()
  ...
  .keys({
    ...
    role: Joi.string().valid(
      ...Object.values(enums.USER_ROLES_ENUM)
    ),
  })
  .validate(data);

exports.updateUserValidator = (data) => Joi.object()
  .options({ abortEarly: false }) // дозволяє повертатии більше однієї помилки одночасно
  .keys({
...
exports.signupUserValidator = (data) => Joi.object()
  .options({ abortEarly: false }) // дозволяє повертатии більше однієї помилки одночасно
  .keys({
    name: Joi.string().max(10).alphanum().required(),
    email: Joi.string().email().required(),
...
exports.loginValidator = (data) => Joi.object()
  .options({ abortEarly: false }) // дозволяє повертатии більше однієї помилки одночасно
  .keys({
    email: Joi.string().email().required(),
...
exports.todoValidator = (data) => Joi.object()
  .options({ abortEarly: false }) // дозволяє повертатии більше однієї помилки одночасно
  .keys({
